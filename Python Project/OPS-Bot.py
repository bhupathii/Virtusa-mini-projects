...
# Keywords we care about (anything else is ignored)
danger_keywords = ["CRITICAL", "ERROR", "FAILED LOGIN"]
# Read the log and filter for suspicious lines
    ...
    for line in f:
        for keyword in danger_keywords:
            if keyword in line:
                ...
                # A line might match multiple keywords, count it once
                break
